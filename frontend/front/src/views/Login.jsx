    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-112px)] px-4">
      <div className="bg-neutral-900/50 border border-neutral-800 p-10 rounded-3xl backdrop-blur-md w-full max-w-md shadow-2xl">
        ...
        <form className="space-y-6">
          <div>
            <label className="block text-gray-400 mb-2 ml-1 text-sm font-medium">Email</label>
            <input 
              ref={emailRef} 
              type="email" 
          ...
          <div>
            <label className="block text-gray-400 mb-2 ml-1 text-sm font-medium">Contraseña</label>
            <input 
              type="password" 
              placeholder="••••••••"
              className="w-full bg-black/40 border border-neutral-700 rounded-xl px-4 py-3 text-white placeholder:text-gray-600 outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/50 transition-all" 
